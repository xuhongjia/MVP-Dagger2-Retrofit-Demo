...
public class WechatTab extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.wechat_tab_bg;
    ...
    public WechatTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        clickable = a.getBoolean(R.styleable.WechatTab_pstsClickable, clickable);
        selectedTabTextColor = a.getColor(R.styleable.WechatTab_pstsSelectedTabTextColor, selectedTabTextColor);
        visibleItemCount = a.getInteger(R.styleable.WechatTab_pstsVisibleCount, visibleItemCount);
        ...
        underLine = a.getBoolean(R.styleable.WechatTab_pstsUnderline,underLine);
        ...
        if(visibleItemCount != 0)
            fixTabLayoutParams =new LinearLayout.LayoutParams(getScreenWidth(context)/visibleItemCount, LayoutParams.MATCH_PARENT);
...
//        setSelectedTextColor(getResources().getColor(R.color.theme_color));
    ...
    private void addTab(final int position, View tab) {
        ...
        if(position==6){
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(getScreenWidth(getContext())/visibleItemCount+80, ViewGroup.LayoutParams.MATCH_PARENT);
            tabsContainer.addView(tab, position, visibleItemCount != 0 ? params : defaultTabLayoutParams);
        }
        else{
            tabsContainer.addView(tab, position, visibleItemCount != 0 ? fixTabLayoutParams : defaultTabLayoutParams);
        }
    }
...
//        }
    ...
    private float dipToPix(Context context, float dipValue) {

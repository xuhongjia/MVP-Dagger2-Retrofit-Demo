...
public class NoScrollSwipeListView extends LZListView {
    ...
    public NoScrollSwipeListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mIsHorizontal != null && mIsHorizontal) {
                    if (mFirstX - lastX > mRightViewWidth / 2 && mCurrentItemView != null) {
